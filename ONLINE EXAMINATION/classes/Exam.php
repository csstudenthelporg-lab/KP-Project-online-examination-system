         ...
         foreach ($ans as $key => $ansName) {
            if ($ansName != '') {
               ...
               if ($rinsert) {
                  ...
                  return "<div class='alert alert-danger'>Error inserting answers.</div>";
               }
            }
         }
         return "<div class='alert alert-success'>Data Inserted Successfuly!</div>";
      } else {
         return "<div class='alert alert-danger'>Data Not Inserted.</div>";
      }
   }
